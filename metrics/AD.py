...
def ts_metrics_enhanced(y_true, y_score, y_test):
    ...
    links_precision = links['Links_Precision']
    links_recall = links['Links_Recall']



    links_f1 = 2 * links_precision * links_recall /(links_precision + links_recall)
    return {'pc_adjust': best_p,
            'rc_adjust': best_r,
            'f1_adjust': best_f1,
            'af_pc': links_precision,
            'af_rc': links_recall,
            'af_f1': links_f1,
